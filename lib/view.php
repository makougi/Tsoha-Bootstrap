        ...
        try {
            ...
            if (method_exists('BaseController', 'get_user_logged_in')) {
                ...
                if (BaseController::get_user_logged_in()) {
                    $content['user_logged_in_name'] = BaseController::get_user_logged_in()->nimi;
                    $content['user_logged_in_tunnus'] = BaseController::get_user_logged_in()->tunnus;
                    $content['user_logged_in_saldo'] = KirjanpitoController::getAsiakas(BaseController::get_user_logged_in()->tunnus)->saldo;
                }
            }
